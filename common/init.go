...
func InitEnv() {
	...
	TrafficRelayBaseURL = strings.TrimRight(strings.TrimSpace(os.Getenv("TRAFFIC_RELAY_BASE_URL")), "/")
...
func initConstantEnv() {
	...
	constant.ImageStreamingTimeout = GetEnvOrDefault("IMAGE_STREAMING_TIMEOUT", 120)
