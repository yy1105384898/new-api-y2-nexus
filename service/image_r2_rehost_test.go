...
func TestRehostSyncImageResponseBodySkipsInternalPrefixModel(t *testing.T) {
	...
	out, err := RehostSyncImageResponseBody(context.Background(), 1, "go2api-gpt-image-2-1k", "https://api.example.com", body)
	if err != nil {
...
func TestRehostImageDataURLsRequiresR2ForUpstreamURL(t *testing.T) {
	...
	for _, model := range []string{"geek2-gpt-image-2-4k", "flux-pro-2", "Gulie-gpt-image-2", "gpt-image-2"} {
